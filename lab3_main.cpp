...
int main() {
	...
	cout << endl;
	cout << "Testing priority queue print method:" << endl;
	cout << endl;
	pqueue_test.test_queue_print();
	cout << endl;
	...
	cout << endl;
	cout << "Testing binary search tree print method:" << endl;
	cout << "(Prints InOrder traversal)" << endl;
	cout << endl;
	bst_test.test_bst_print();
	cout << endl;	
}
